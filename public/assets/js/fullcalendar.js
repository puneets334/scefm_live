...
var EmitterMixin = /** @class */ (function (_super) {
    ...
    EmitterMixin.prototype._prepareIntercept = function (handler) {
        ...
        // https://github.com/jquery/jquery/blob/3.7.1/src/core.js#L448
...
moment_ext_1.newMomentProto.toISOString = function () {
    ...
    if (this._fullCalendar) { // enhanced non-ambig moment?
        ...
        // https://github.com/moment/moment/blob/2.30.1/src/lib/moment/format.js#L22
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderMoreLink = function (row, col, hiddenSegs) {
        var _this = this;
        var view = this.view;
        return $('<a class="fc-more" style="font-size: 16px; color: green;"/>')
    ...
    DayGrid.prototype.renderSegPopoverContent = function (row, col, segs) {
        ...
        var content = $('<div class="fc-header ' + theme.getClass('popoverHeader') + '">' +
            ...
            '<span class="fc-title" style="line-height: 20px !important;">' +
            util_1.htmlEscape(title) +
            '</span>' +
            '<div class="fc-clear"/>' +
            '</div>' +
            '<div class="fc-body ' + theme.getClass('popoverContent') + '">' +
            '<div class="fc-event-container"></div> <span class="mess_view"></span>' +
            '</div>');
    ...
    BasicView.prototype.renderSkeletonHtml = function () {
        ...
        return '' +
            ...
            (this.opt('columnHeader') ?
                '<thead class="fc-head">' +
                    '<tr>' +
                    '<td class="fc-head-container ' + theme.getClass('widgetHeader') + '" style="background: #d6d6d6;">&nbsp;</td>' +
                    '</tr>' +
                    '</thead>' :
                '') +
            '<tbody class="fc-body">' +
    ...
    TimeGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        return '<a class="' + classes.join(' ') + '"' +
            ...
            (timeText ?
                ...
                '') +
            (eventDef.title ?
                '<div class="fc-title" style="line-height: 20px !important;">>' +
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    DayGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        titleHtml =
            '<span class="fc-title" style="line-height: 15px !important;">' +
