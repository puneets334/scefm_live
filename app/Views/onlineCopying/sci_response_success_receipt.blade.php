  ...
  <tr>
    <td>
        ...
        style="border-collapse: collapse;width: 100%;max-width: 800px;margin: 0 auto;">
            <tr>
                <th style="font-family:'Arial'; text-align: center; font-size: 18px; color: #fff; padding: 20px 10px; background: #57b223; border-bottom:1px solid #fff">#</th>
                ...
                <th style="font-family:'Arial'; text-align: center; font-size: 18px; color: #fff; padding: 20px 10px; background: #57b223; border-bottom:1px solid #fff">Total</th>
            </tr>
            <tr>
                <td style="font-family:'Arial'; text-align: center; font-size: 18px; color: #fff; padding: 20px 10px; background: #57b223; border-bottom:1px solid #fff;">1</td>
                <td style="font-family:'Arial'; text-align: left; font-size: 18px; color: #000; padding: 20px 10px; background: #eeeeee; border-bottom:1px solid #fff;">
                   <div style="font-family:'Arial'; text-align: left; font-size: 18px; color: #57b223; padding: 0px 10px 8px 10px;">For Copy of Diary No. <?php echo (!empty($diary_no) ? $diary_no : '') ?></div>
                ...
                <td style="font-family:'Arial'; text-align: center; font-size: 18px; color: #00000; padding: 20px 10px; background: #57b223; border-bottom:1px solid #fff;">Rs. <?php echo (!empty($OrderBatchTotalAmounts) ? $OrderBatchTotalAmounts : '') ?></td>
            </tr>
        </table>
