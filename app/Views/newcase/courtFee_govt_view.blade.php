        ...
        <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php
                    $attribute = array('class' => 'form-horizontal', 'name' => 'court_fee_details', 'id' => 'court_fee_details', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data');
                    echo form_open('newcase/courtFee/add_govt_court_fee_details', $attribute);
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        // if the case type is Arbitration Petition, Curative Petition or Original Suit the Printing Charges shall be calculated as Rs 0.75/- per page * multiplied by 6 Sets = Rs 4.5/- per page to be charged.
                            ...
                            <div class="row">
                                <div class="col-sm-8 col-xs-8">
                                    <table id="datatable-responsive1" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $if_sclsc=(!empty($_SESSION['efiling_details']['if_sclsc']) && ($_SESSION['efiling_details']['if_sclsc'] ==1)) ? $_SESSION['efiling_details']['if_sclsc'] : 0;
                                            $sr_no=1;
                                            ...
                                            if (!empty($_SESSION['efiling_details']['if_sclsc']) && ($_SESSION['efiling_details']['if_sclsc'] ==1)) {
                                                $case_nature='R'; //SET case nature as Criminal to mke court fee 0 if is_slsc selected by AOR/PIP
                                            }
                                            ...
                                            if(!empty($court_fee_list1)){
                                            foreach ($court_fee_list1 as $row) {
                                                $base_case_subject_category_details = get_challanged_sc_base_case_details($registration_id, $row['sc_case_type_id']);
                                                if ($row['sc_case_type_id'] == '9' || $row['sc_case_type_id'] == '25' || $row['sc_case_type_id'] == '39' ) // for Review Petition, Curative Petition, Contempt petition(came from lower court) and MA : Court Fee is to be paid same as having paid in the Main/base Matter
                                                {
                                                    ...
                                                    } else if ($row['sc_case_type_id'] == 39) {
                                                ...
                                                <tr style="color: #0d6aad;size: 20px;">
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        if($case_nature == 'C') {
                                                            $court_fee1=0;
                                                            if($sc_case_type_id=='39' || $case_type_id=='39')  // 100 court fee will be applicable for the MA added by kbp on 17072023
                                                            {
                ...
                /*                                            if ($case_nature == 'C')
                                ...
                                <div class="col-sm-4 col-xs-4" style="margin-top: 5%;">
                                    ...
                                    <div class="col-lg-12 ccol-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label col-md-4 col-sm-12 col-xs-12 input-sm">Enter Challan No. <span style="color: red">*</span></label>
                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                <div class="input-group">
                                                    <input type="text" id="challan_no" name="challan_no" minlength="10" maxlength="18" class="form-control cus-form-ctrl input-lg" placeholder="DLCT0716F2344T690" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 ccol-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label col-md-4 col-sm-12 col-xs-12 input-sm">Upload Challan <span style="color: red">*</span></label>
                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                <div class="input-group">
                                                    <input type="file" id="challan_file" name="challan_file" class="form-control cus-form-ctrl input-lg" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 ccol-md-12 col-sm-12 col-xs-12">
                                        ...
                                        ?>
                                        <!--<div class="form-group">
                                            <label class="control-label col-md-5 col-sm-12 col-xs-12 input-sm">Court Fee<br> (To Pay)( <i class="fa fa-rupee"></i> ) <span style="color: red">*</span></label>
                        ...
                        <div class="col-lg-6 ccol-md-6 col-sm-12 col-xs-12"></div>
                    </div>
