            ...
            <div class="col-sm-12 col-xs-12">
                ...
                <div id="hc_entry_div">
                    ...
                    <div id="high_court_info" style="display: block;">
                        ...
                        <div class="col-sm-12 col-xs-12 hc_case_type_name" style="display:<?=$case_type_id_zero;?>">
                            <div class="form-group">
                                <label class="control-label">Case Type Name <span style="color: red">*</span></label>
                                <input type="text" name="hc_case_type_name" id="hc_case_type_name" value="<?php echo $subordinate_court_details[0]['casetype_name'];?>" class="form-control input-sm" placeholder="Enter Case Type Name" maxlength="100">
                            </div>
                        </div>
                    ...
                    <div id="district_court_info" style="display: block;">
                        ...
                        <div class="col-sm-12 col-xs-12 dc_case_type_name" style="display:<?=$case_type_id_zero;?>">
                            <div class="form-group">
                                <label class="control-label">Case Type Name <span style="color: red">*</span></label>
                                <input type="text" name="dc_case_type_name" id="dc_case_type_name" value="<?php echo $subordinate_court_details[0]['casetype_name']; ?>" class="form-control input-sm" placeholder="Enter Case Type Name" maxlength="100">
                            </div>
                        </div>
                  ...
                  <?php } else if ($court_type==5){?>
                    <div id="state_agency_info" style="display: block;">
                        ...
                        <div class="col-sm-12 col-xs-12 agency_case_type_name" style="display:<?=$case_type_id_zero;?>">
                            <div class="form-group">
                                <label class="control-label">Case Type Name <span style="color: red">*</span></label>
                                <input type="text" name="agency_case_type_name" id="agency_case_type_name" value="<?php echo $subordinate_court_details[0]['casetype_name']; ?>" class="form-control input-sm" placeholder="Enter Case Type Name" maxlength="100">
                            </div>
                        </div>
