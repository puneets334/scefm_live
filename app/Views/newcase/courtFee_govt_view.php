                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-xs-8">
                        <table id="datatable-responsive1" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            $if_sclsc=(!empty($_SESSION['efiling_details']['if_sclsc']) && ($_SESSION['efiling_details']['if_sclsc'] ==1)) ? $_SESSION['efiling_details']['if_sclsc'] : 0; //Code added for to make 0 court fee for SCLSC cases on 25072023 by Anshu and KBP
                    ...
                    <div class="col-sm-4 col-xs-4" style="margin-top: 5%;">
                        ...
                        <div class="col-lg-12 ccol-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-12 col-xs-12 input-sm">Enter Challan No.
                                    <span style="color: red">*</span></label>
                                <div class="col-md-8 col-sm-12 col-xs-12">
                                    <div class="input-group " >
                                        <input type="text" id="challan_no" name="challan_no" minlength="10" maxlength="18" class="form-control input-lg " placeholder="DLCT0716F2344T690">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 ccol-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-12 col-xs-12 input-sm">Upload Challan
                                    <span style="color: red">*</span></label>
                                <div class="col-md-8 col-sm-12 col-xs-12">
                                    <div class="input-group " >
                                        <input type="file" id="challan_file" name="challan_file"  class="form-control input-lg">
                                    </div>
                                </div>
                            </div>
                        </div>
