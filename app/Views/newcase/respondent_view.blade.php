                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <select name="party_state" id="party_state" tabindex='24' class="cus-form-ctrl filter_select_dropdown">
                    ...
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <select name="party_district" id="party_district" tabindex='25' class="cus-form-ctrl filter_select_dropdown party_district">
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if ((is_dead_minor) && is_dead_minor == '1' && (res == 96 || res !=
                            ...
                            $("#party_state").removeAttr('required');
                            $("#district_span").html('');
                            $("#district_span").css({
                                'color': ''
                            });
