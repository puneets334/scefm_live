                                ...
                                <div class="right_col" role="main">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="inner-page-title">              
                                                ...
                                                <?php } else { ?> 
                                                    <!-- <h2><i class="fa  fa-newspaper-o"></i> Refile Old eFiling Cases</h2>
                                                    <div class="clearfix"></div> -->
                                                    <h5>Refile Old eFiling Cases</h5>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>        
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                <div class="x_content">
                                                    <embed src="<?php echo base_url('/uploaded_docs/user_manual/Independent_Old_Refiling.pdf'); ?>" type="application/pdf" width="100%" height="800">
                                                </div>
                                            </div>
                                        </div>
                                        <!------------Table--------------------->
